...
def scrape_all():
    ...
    browser = Browser('chrome', executable_path="C:/Users/deyul/OneDrive/Documents/Data Analytics Bootcamp/File Folder/Web_Scraping/Mission-to-Mars/chromedriver", headless=True)
    ...
    data = {
        ...
        'hemisphere_image_and_title': mars_hesmispheres(browser)
    }
...
def mars_hesmispheres(browser):
    ...
    # Iterate through the 4 Hemisphere links to scrape the image URLs and titles. Add the scrapped result into a list of 4 distionaries.
    image_url_full=[]
